 ...
 */
public class GzabeMsgController extends MsgControllerAdapter {

	static Log logger = Log.getLog(GzabeMsgController.class);
	...
	/*	ac.setToken(PropKit.get("token"));
		...
		ac.setToken("wa1992");
		ac.setAppId("wxf3bea00007fb0b0c");
		ac.setAppSecret("f4a69ad93a7a3a8fed919ca74d356d54");
	...
	protected void processInTextMsg(InTextMsg inTextMsg)
	{
		...
		AutoReply auto = AutoReply.dao.findFirst("select * from wxhocrm_autoreply where keywords=?",inTextMsg.getContent());
		OutTextMsg outTextMsg= new OutTextMsg(inTextMsg);
		if(auto!=null)
			outTextMsg.setContent(auto.getStr("Content"));
		else{
			OutCustomMsg outCustomMsg = new OutCustomMsg(inTextMsg);
			render(outCustomMsg);
			return;
