...
public class DateUtil {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("月未最后一天：" + DateUtil.getLastDayOfMonth("2015", "11"));
			System.out.println("相差几天：" + DateUtil.getIntevalDays("2010-08-01", "2010-08-21"));

			System.out.println("当前日期后的几天：" + DateUtil.getNextDate("2015-11-24", -3));
			System.out.println("与今天相差几天：" + DateUtil.getTodayIntevalDays("2015-08-01"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
